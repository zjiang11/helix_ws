...
file_path = '/root/helix_ws/data/test_state_jackal_kalman_filter/csv_data/jackal_state_10_angular.csv' 
data = pd.read_csv(file_path)

# Extract columns

timestamps = data['Timestamp'].values
velocities = data['Current Theta Speed'].values
inputs = data['Current Input W'].values
...
params_file_path = '/root/helix_ws/data/test_state_jackal_kalman_filter/params_ab_angular.csv'
...
plt.savefig('/root/helix_ws/data/test_state_jackal_kalman_filter/state_test_angular.png')
